...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdjustmentResources) DeepCopyInto(out *AdjustmentResources) {
	*out = *in
	if in.Limits != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdjustmentResources.
func (in *AdjustmentResources) DeepCopy() *AdjustmentResources {
	if in == nil {
		return nil
	}
	out := new(AdjustmentResources)
	in.DeepCopyInto(out)
	return out
}
